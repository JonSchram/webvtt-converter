...
import com.jonathanschram.vttconverter.lib.vtt.parsing.IncorrectFormatException;
import com.jonathanschram.vttconverter.lib.vtt.parsing.VttParser;
        ...
        if (!commandArgs.hasOption("help") && !commandArgs.hasOption("version")) {
            ...
            for (String path : unparsedArgs) {
                ...
                try {
                    ...
                    System.out.println("Input not a VTT file.");
                    e.printStackTrace();
                }
            }
        }
